...
Route::middleware(['auth'])->prefix('/dashboard')->group(function () {
    ...
    Route::get('/roles', RolesIndex::class)->name('roles.index')->middleware('permission:view roles');
    Route::get('/roles/create', RoleForm::class)->name('roles.create')->middleware('permission:create role');
    Route::get('/roles/{role}/edit', RoleForm::class)->name('roles.edit')->middleware('permission:edit role');

    Route::get('/users', UsersIndex::class)->name('users.index')->middleware('permission:view users');
    Route::get('/users/create', UserForm::class)->name('users.create')->middleware('permission:create user');
    Route::get('/users/{user}/edit', UserForm::class)->name('users.edit')->middleware('permission:edit user');

    Route::get('/projects', ProjectIndex::class)->name('projects.index')->middleware('permission:view project');
    ...
    Route::get('/tasks', TaskBoard::class)->name('tasks.board')->middleware('permission:view task');
